...
const { newApp, newDao, ANY_ADDRESS, APP_ID } = require("./utils/voting/dao.js");
...
const {
  ...
  days,
  defaultParams,
} = require("./utils/voting/deploy_infrastructure.js");
...
describe("Voting", () => {
  ...
  const configuration = async () => {
    ...
    [_, _, _, _, _, voting] = await deployment.proceed();
  }
