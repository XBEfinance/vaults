...
interface IBankV2 is IERC20 {
    ...
    function configure(address _eurxb, address _ddp, address _vault, address _bond) virtual external;

    function setBondHolder(uint256 _bondId, address _owner) virtual external;

    function setVault(address _vault) virtual external;
    ...
    function redeemBond(uint256 bondId) virtual external;
}
