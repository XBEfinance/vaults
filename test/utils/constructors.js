...
module.exports = {
  ...
  ConsumerEURxbVault: async (params) => [await getDefaultTxParams()],
  InstitutionalEURxbVault: async () => [await getDefaultTxParams()],
  HiveVault: async (params) => [await getDefaultTxParams()],
  ...
  InstitutionalEURxbStrategy: async (params) => [await getDefaultTxParams()],
  ConsumerEURxbStrategy: async (params) => [await getDefaultTxParams()],
