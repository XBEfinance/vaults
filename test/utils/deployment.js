...
module.exports = {
  ...
  Vault: getDeployerFuncWithDefaultConstructor('Vault'),
  SushiVault: getDeployerFuncWithDefaultConstructor('SushiVault'),
  CVXVault: getDeployerFuncWithDefaultConstructor('Vault'),
  CvxCrvVault: getDeployerFuncWithDefaultConstructor('Vault'),
